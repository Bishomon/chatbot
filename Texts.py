...
text2 = """&#128681; <b>Для отправки запроса напишите нам:</b>
— Артикул лота;
— Ваше имя;
— Номер телефона;
— Ваш вопрос;
...
text3 = """&#128272; <b>Полная информация о лотах представлена в нашем закрытом канале.</b>
...
text4 = """&#128273; <b>Оформить подписку на закрытый каталог объектов с торгов (ссылка — https://t.me/+o9Hu7rJRWgdmNTZi ) - нажмите.</b>
...
text5 = """&#128218; <b>Выкуп имущества с торгов включает в себя 4 этапа.</b>
...
text9 = """&#128304; <b>Стандартный - 10.000₽ + % после победы</b>
...
text11 = """&#128200; <b>По вашему запросу мы подберем ряд объектов, точно подходящих под ваши критерии.</b>
...
text12 = """&#9830; <b>Оставьте заявку в следующем формате:</b>
— ФИО;
— Номер телефона;
— Вид объекта;
— Локация;
...
text13 = """&#127919; <b>В команде работают опытные риэлторы, готовые предложить вам эксклюзивные объекты от лучших застройщиков Москвы по специальным ценам.</b>
...
text14 = """Выберите интересующий каталог"""

text15 = """&#128273; <b>Оформить подписку на закрытый каталог объектов с торгов (ссылка - https://t.me/+o9Hu7rJRWgdmNTZi )</b>"""

text16 = """
        Так же можем предложить вам следующие услуги:
"""

text17 = """&#127957; <b>Один из вариантов приобретения земельных участков — оформление свободной земли, которая принадлежит государству.</b>
...
text18 = """&#128273; <b>Работа под ключ - 150.000₽</b>
...
text19 = """Выберите интересующую вас услугу"""

text20 = """&#128205; Для получения точных координат объекта введите его кадастровый номер в графу поиска на <b>кадастровой карте</b> (гиперссылка — https://rosreestr-doc.ru/кадастровая_карта ). Далее скопируйте координаты в формате 55.754681, 37.621389 и вставьте их в Яндекс.Карты/Google Карты."""

text21 = """&#128681; Отправьте нам артикул лота, ваш вопрос и номер телефона. Мы предоставим информацию в ближайшее время."""

text22 = """&#128272; <b>Полная информация о лотах представлена в нашем закрытом канале.</b>
...
text23 = """ &#128273; <b>Оформить подписку на закрытый каталог объектов с торгов (ссылка — https://t.me/+o9Hu7rJRWgdmNTZi ) - нажмите.</b>

При оплате картой сервис запомнит её данные и раз в месяц будет автоматически продлять подписку.

По всем вопросам обращайтесь в поддержку @demo_support"""

text24 = """&#127909; <b>В рамках услуги по осмотру объекта осуществляется фото и видео съёмка. Также в формате онлайн оказывается консультация с ответами на вопросы по месту.</b>

Услуга стоит от 5.000 рублей без онлайн консультации и от 7.000 с онлайн консультацией."""

text25 = """&#9830; Отправьте нам адрес объекта и ссылку на торги, мы проверим возможность осмотра на ближайшее время и ответим вам в течении 24 часов. """

text26 = """&#127957; <b>Один из вариантов приобретения земельных участков — оформление свободной земли, которая принадлежит государству.</b>
...
text27 = """&#128273; <b>Работа под ключ - 150.000₽</b>
1) Предварительное согласование земельного участка;
2) Подбор земельного участка в конкретной локации (радиус от 5 км от предпочтительной локации);
3) Участие в аукционе;
4) Заключение ДКП и регистрация права собственности;"""

text28 = """&#128222 Связь с менеджером
...
text30 = """Выберите интересующую вас опцию
          """

text31 = """Контакты менеджера
              """

text32 = """<b>Добрый день!</b> Вы находитесь в чате команды <b>DEMO.Estate.</b> 
        Мы оказываем следующие услуги:
        - <b>Выкуп имущества с торгов;</b>
        - Подбор объектов недвижимости на торгах и на открытом рынке;
        - Осмотр объекта недвижимости;
